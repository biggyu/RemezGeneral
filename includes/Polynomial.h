...
public:
	...
	// void homomorphic_poly_evaluation(shared_ptr<SEALContext> &context, CKKSEncoder &encoder, Encryptor &encryptor, Evaluator &evaluator, RelinKeys &relin_keys, double scale, Ciphertext &rtn, Ciphertext &cipher);
};
